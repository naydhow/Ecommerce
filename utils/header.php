            ...
            <div class='carrinho'>
                ...
                <footer id='footer_cart'>
                    <div class='buttons_cart'>
                        <a href='./venda/selecao_produtos_front.php' id='continuar-comprando'>Continuar Comprando</a>
                        <a href='./venda/confirmacao_compra_front.php'>Finalizar Compra</a>
                        <a href='./venda/carrinho_front.php'>Ir ao Carrinho</a>
                    </div>
                </footer>
            </div>
